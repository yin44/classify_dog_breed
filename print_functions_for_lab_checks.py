        ...
        for key in results_dic:
            ...
            if results_dic[key][2] == 1:
                ...
                """print("\n{:>30}: \nReal: {:>26}   Classifier: {:>30}  \nPetLabelDog: {:1d}  ClassLabelDog: {:1d}".format(key,
                      ...
                      results_dic[key][4]))
                """
                print("\n{:>30}: \nReal: {:>26}   Classifier: {:>30}  \nPetLabelDog: {}  ClassLabelDog: {}".format(
                    key,
                    results_dic[key][0], 
                    results_dic[key][1], 
                    results_dic[key][3],  # Convert to integer to ensure correct type
                    results_dic[key][4]   # Convert to integer to ensure correct type
                ))
...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        """
        # Calculate statistics based on counters from above
        n_pet_notd = n_images - n_pet_dog
