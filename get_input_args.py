...
def get_input_args():
    ...
    # Define --arch argument with type and help description
    parser.add_argument('--arch', type=str, default='vgg', 
                        help='CNN model architecture to use for classification (e.g., "vgg", "resnet")')
    
    # Define --dogfile argument with type and help description
